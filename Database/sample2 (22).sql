...
--
-- Host: db
-- Generation Time: Nov 29, 2023 at 02:47 PM
...
(1, 'Potato', 100.50, 775.00, 8, '2023-11-22 11:48:28.074218', '2023-12-31 23:59:59.000000', '2023-11-22 11:48:28.074258', 'Origin: Bagerhatt\r\nColor: Red\r\nType: Vegetables', ''),
...
INSERT INTO `pending_businessmen_payment` (`id`, `post_id`, `name`, `amount`, `price`, `businessman_userid`, `farmer_userid`) VALUES
(4, 2, 'Tomato', 10.99, 6000.00, 'Azam Khan', 'korimali'),
(5, 3, 'Brocoli', 10.99, 54000.00, 'Azam Khan', 'korimali'),
(6, 7, 'Aman Rice', 500.00, 400.00, 'Azam Khan', 'korimali'),
(7, 34, 'Tomato', 99.00, 58000.00, 'Azam Khan', 'Didar');
...
INSERT INTO `pending_farmer_payment` (`pending_payment_id`, `userid`, `transaction_id`, `amount`, `product_id`, `name`, `location`) VALUES
...
--
ALTER TABLE `pending_farmer_payment`
  MODIFY `pending_payment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
