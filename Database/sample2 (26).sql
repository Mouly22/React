...
--
-- Host: db
-- Generation Time: Dec 01, 2023 at 04:17 PM
...
(16, 'korimali', '12345', 'korimali@gmail.com', 'Madaripur', 342732, 'farmer'),
(17, 'masum', '12345', 'masum12@gmail.com', 'Mirpur', 1343423, 'deliveryman');
...
(29, 39, 'auction_images/211.jpg'),
(30, 40, 'auction_images/basmati_rice_sqsy82q.webp'),
(31, 41, 'auction_images/apple.png'),
(32, 42, 'auction_images/kolmi_shak_tOLSI1z.jpeg'),
(33, 43, 'auction_images/apple_aVcR0ES.png'),
(34, 44, 'auction_images/211_GWeKSDV.jpg');
...
(101, 'Can add react', 26, 'add_react'),
(102, 'Can change react', 26, 'change_react'),
(103, 'Can delete react', 26, 'delete_react'),
(104, 'Can view react', 26, 'view_react'),
(105, 'Can add react', 27, 'add_react'),
(106, 'Can change react', 27, 'change_react'),
(107, 'Can delete react', 27, 'delete_react'),
(108, 'Can view react', 27, 'view_react'),
(109, 'Can add react', 28, 'add_react'),
(110, 'Can change react', 28, 'change_react'),
(111, 'Can delete react', 28, 'delete_react'),
(112, 'Can view react', 28, 'view_react'),
(113, 'Can add react', 29, 'add_react'),
(114, 'Can change react', 29, 'change_react'),
(115, 'Can delete react', 29, 'delete_react'),
(116, 'Can view react', 29, 'view_react'),
(117, 'Can add react', 30, 'add_react'),
(118, 'Can change react', 30, 'change_react'),
(119, 'Can delete react', 30, 'delete_react'),
(120, 'Can view react', 30, 'view_react'),
(121, 'Can add react', 31, 'add_react'),
(122, 'Can change react', 31, 'change_react'),
(123, 'Can delete react', 31, 'delete_react'),
(124, 'Can view react', 31, 'view_react'),
(125, 'Can add react', 32, 'add_react'),
(126, 'Can change react', 32, 'change_react'),
(127, 'Can delete react', 32, 'delete_react'),
(128, 'Can view react', 32, 'view_react'),
(129, 'Can add react', 33, 'add_react'),
(130, 'Can change react', 33, 'change_react'),
(131, 'Can delete react', 33, 'delete_react'),
(132, 'Can view react', 33, 'view_react');
...
(28, 'masum', 'Thinking of starting my own business', 2),
(29, 'Mouly', 'Very inspiring news! Keep it up', 11);
...
(4, 'mouly', 'Gazipur', 'Dhaka'),
(5, 'mouly', 'Brahmanbaria', 'Chittagong'),
(6, 'mouly', 'Faridpur', 'Dhaka'),
(7, 'mouly', 'Chittagong', 'Chittagong'),
(8, 'mouly', 'Dhaka', 'Dhaka'),
(9, 'kamal', 'Faridpur', 'Dhaka');
...
(14, 13, 'images/logo3_N2he5E0.png');
...
--
-- Table structure for table `deliverymen_credentials`
--

CREATE TABLE `deliverymen_credentials` (
  `id` bigint NOT NULL,
  `userid` varchar(30) NOT NULL,
  `password` varchar(200) NOT NULL,
  `email` varchar(200) NOT NULL,
...
--
-- Table structure for table `delivery_bounties`
--

CREATE TABLE `delivery_bounties` (
  `pending_payment_id` int NOT NULL,
...
INSERT INTO `delivery_bounties` (`pending_payment_id`, `userid`, `transaction_id`, `amount`, `product_id`, `name`, `location`) VALUES
(2, 'korimali', 'aka42333a', 100.00, 2, 'Mango', 'Bogura'),
(3, 'mohaiminul', 'afa42333a', 100.00, 3, 'Big Mango', 'Bogura2'),
(4, 'korimali', 'dfsaasdfsa1', 10.99, 3, 'Brocoli', 'Madaripur'),
(7, 'korimali', 'dafas2312', 50.00, 37, 'Rui Mach', 'Madaripur');

-- --------------------------------------------------------

--
-- Table structure for table `delivery_bounties_booked`
--

CREATE TABLE `delivery_bounties_booked` (
  `pending_delivery_id` int NOT NULL,
  `deliveryman_userid` varchar(255) NOT NULL,
...
INSERT INTO `delivery_bounties_booked` (`pending_delivery_id`, `deliveryman_userid`, `delivery_state`, `transaction_id`, `amount`, `product_id`, `name`, `location`) VALUES
(2, 'masum', 'Received From Farmer', 'aka42333a', 100.00, 2, 'Mango', 'Bogura'),
(3, 'masum', 'On The Way', 'afa42333a', 100.00, 3, 'Big Mango', 'Bogura2'),
(5, 'masum', 'On The Way', 'esfdsdfs', 200.00, 15, 'Eggplant', 'Madaripur');
...
(30, 'delivery_bountys', 'react'),
(31, 'delivery_bountys_booked', 'react'),
(29, 'deliverymen', 'react'),
(17, 'expert', 'react'),
(26, 'farmer_credentials', 'react'),
(33, 'farmer_wallet', 'react'),
...
(27, 'pending_businessmen_payment', 'react'),
(28, 'pending_farmer_payment', 'react'),
(32, 'pending_on_delivery_products', 'react'),
(6, 'sessions', 'session');
...
(42, 'farmer_credentials', '0001_initial', '2023-11-25 08:12:20.217953'),
(43, 'pending_businessmen_payment', '0001_initial', '2023-11-29 05:17:35.987623'),
(44, 'pending_farmer_payment', '0001_initial', '2023-11-29 14:35:33.184627'),
(45, 'deliverymen', '0001_initial', '2023-11-29 15:16:44.856201'),
(46, 'delivery_bountys', '0001_initial', '2023-11-30 12:48:07.820757'),
(47, 'delivery_bountys_booked', '0001_initial', '2023-11-30 13:32:52.615407'),
(48, 'pending_businessmen_payment', '0002_react_location', '2023-11-30 19:40:37.248174'),
(49, 'pending_on_delivery_products', '0001_initial', '2023-11-30 21:00:04.609342'),
(50, 'pending_farmer_payment', '0002_rename_amount_react_price', '2023-12-01 12:57:33.341725'),
(51, 'farmer_wallet', '0001_initial', '2023-12-01 14:15:53.481470'),
(52, 'farmer_wallet', '0002_alter_react_userid', '2023-12-01 14:17:34.468927');
...
(1, 'Potato', 100.50, 853.00, 10, '2023-11-22 11:48:28.074218', '2023-12-31 23:59:59.000000', '2023-11-22 11:48:28.074258', 'Origin: Bagerhatt\r\nColor: Red\r\nType: Vegetables', ''),
...
(39, 'Corn', 20.00, 20030.00, 1, '2023-12-01 10:28:39.660240', '2023-12-15 16:28:00.000000', '2023-12-01 10:28:39.660515', 'Type: Vegetable\r\nOrigin: Bogura\r\nColor: Bright', 'korimali'),
(40, 'Basmati Rice', 50.00, 80400.00, 1, '2023-12-01 10:29:26.146995', '2023-12-02 16:29:00.000000', '2023-12-01 10:29:26.147088', 'Type: Crop\r\nOrigin: Khulna\r\nColor: Bright', 'korimali'),
(41, 'Apple', 12.00, 2000.00, 0, '2023-12-01 10:30:11.828883', '2023-12-07 16:30:00.000000', '2023-12-01 10:30:11.828968', 'Type: Fruits\r\nOrigin: Thailand\r\nType: Fresh', 'korimali'),
(42, 'Water Spinach', 12.00, 20000.00, 0, '2023-12-01 10:36:11.921762', '2023-12-13 16:35:00.000000', '2023-12-01 10:36:11.922086', 'Type: Vegetables\r\nOrigin: Barisal\r\nColor: Bright', 'korimali'),
(43, 'Apple', 20.00, 50000.00, 0, '2023-12-01 10:40:24.237309', '2023-12-01 16:45:00.000000', '2023-12-01 10:40:24.237390', 'Type: Fruits\r\nOrigin: Dhaka\r\nType: Fresh', 'korimali'),
(44, 'Corn', 20.00, 12000.00, 0, '2023-12-01 10:41:50.820454', '2023-12-01 16:43:00.000000', '2023-12-01 10:41:50.820553', 'Type: Vegetable\r\nOrigin: Bogura\r\nType: Best', 'korimali');

-- --------------------------------------------------------

--
-- Table structure for table `farmer_credentials`
--

CREATE TABLE `farmer_credentials` (
  `id` bigint NOT NULL,
  `userid` varchar(30) NOT NULL,
  `password` varchar(200) NOT NULL,
  `email` varchar(200) NOT NULL,
...
INSERT INTO `farmer_credentials` (`id`, `userid`, `password`, `email`, `address`, `nid`, `user_type`) VALUES
(1, 'korimali', '12345', 'korimali@gmail.com', 'Madaripur', 342732, 'farmer'),
(2, 'masum', '12345', 'masum12@gmail.com', 'Mirpur', 1343423, 'deliveryman');
...
INSERT INTO `farmer_wallet` (`id`, `userid`, `total_money`) VALUES
(1, 'korimali', 100.00);
...
(1, 1, 1200.00, 853.00, 'korimali', 0),
(10, 22, 50000.00, 2000.00, '', 0),
(17, 36, 30000.00, 21000.00, 'Didar', 0),
(23, 39, 99999999.00, 20030.00, 'Azam Khan', 0),
(24, 40, 90000.00, 80400.00, 'Azam Khan', 0),
(25, 41, 99999999.00, 2000.00, '', 0),
(26, 42, 99999999.00, 20000.00, '', 0),
(27, 43, 99999999.00, 50000.00, '', 0),
(28, 44, 99999999.00, 12000.00, '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `pending_businessmen_payment`
--

CREATE TABLE `pending_businessmen_payment` (
  `id` bigint NOT NULL,
  `post_id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `amount` decimal(10,2) NOT NULL,
...
INSERT INTO `pending_businessmen_payment` (`id`, `post_id`, `name`, `amount`, `price`, `businessman_userid`, `farmer_userid`, `location`) VALUES
(10, 38, 'Mango', 100.00, 50000.00, 'Azam Khan', 'korimali', 'some_default_value');

-- --------------------------------------------------------

--
-- Table structure for table `pending_farmer_payment`
--

CREATE TABLE `pending_farmer_payment` (
  `pending_payment_id` int NOT NULL,
  `userid` varchar(255) NOT NULL,
  `transaction_id` varchar(255) NOT NULL,
  `price` decimal(10,2) NOT NULL,
...
INSERT INTO `pending_farmer_payment` (`pending_payment_id`, `userid`, `transaction_id`, `price`, `product_id`, `name`, `location`) VALUES
(1, 'korimali', 'afa42333a', 100.00, 1, 'tomato', 'Bogura'),
(2, 'korimali', 'aka42333a', 6000.00, 2, 'Mango', 'Bogura'),
(3, 'mohaiminul', 'afa42333a', 54000.00, 3, 'Big Mango', 'Bogura2'),
(6, 'korimali', 'faldjla3121', 99.00, 34, 'Tomato', 'Madaripur'),
(7, 'korimali', 'lj34h3434', 400.00, 7, 'Aman Rice', 'Madaripur'),
(8, 'korimali', 'dfsaasdfsa1', 10.99, 3, 'Brocoli', 'Madaripur'),
(9, 'korimali', 'esfdsdfs', 5000.00, 15, 'Eggplant', 'Madaripur'),
(11, 'korimali', 'dafas2312', 13500.00, 37, 'Rui Mach', 'Madaripur');

-- --------------------------------------------------------

--
-- Table structure for table `pending_on_delivery_products`
--

CREATE TABLE `pending_on_delivery_products` (
  `id` bigint NOT NULL,
  `post_id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `amount` decimal(10,2) NOT NULL,
...
INSERT INTO `pending_on_delivery_products` (`id`, `post_id`, `name`, `amount`, `price`, `businessman_userid`, `farmer_userid`, `location`) VALUES
(1, 7, 'Aman Rice', 500.00, 400.00, 'Azam Khan', 'korimali', 'Madaripur'),
(2, 3, 'Brocoli', 10.99, 54000.00, 'Azam Khan', 'korimali', 'Madaripur'),
(3, 15, 'Eggplant', 200.00, 5000.00, 'Azam Khan', 'korimali', 'Madaripur'),
(5, 37, 'Rui Mach', 50.00, 13500.00, 'Azam Khan', 'korimali', 'Madaripur');
...
--
-- Indexes for table `deliverymen_credentials`
--
ALTER TABLE `deliverymen_credentials`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `delivery_bounties`
--
ALTER TABLE `delivery_bounties`
  ADD PRIMARY KEY (`pending_payment_id`);

--
-- Indexes for table `delivery_bounties_booked`
--
ALTER TABLE `delivery_bounties_booked`
  ADD PRIMARY KEY (`pending_delivery_id`);
...
--
-- Indexes for table `farmer_credentials`
--
ALTER TABLE `farmer_credentials`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `farmer_wallet`
--
...
--
-- Indexes for table `pending_businessmen_payment`
--
ALTER TABLE `pending_businessmen_payment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pending_farmer_payment`
--
ALTER TABLE `pending_farmer_payment`
  ADD PRIMARY KEY (`pending_payment_id`);

--
-- Indexes for table `pending_on_delivery_products`
--
ALTER TABLE `pending_on_delivery_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `deliverymen_credentials`
--
ALTER TABLE `deliverymen_credentials`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `delivery_bounties`
--
ALTER TABLE `delivery_bounties`
  MODIFY `pending_payment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `delivery_bounties_booked`
--
ALTER TABLE `delivery_bounties_booked`
  MODIFY `pending_delivery_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `farmer_auction_posts_inventory_list`
  MODIFY `post_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `farmer_credentials`
--
ALTER TABLE `farmer_credentials`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `farmer_wallet`
--
ALTER TABLE `farmer_wallet`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `pending_businessmen_payment`
--
ALTER TABLE `pending_businessmen_payment`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `pending_farmer_payment`
--
ALTER TABLE `pending_farmer_payment`
  MODIFY `pending_payment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `pending_on_delivery_products`
--
ALTER TABLE `pending_on_delivery_products`
